...
const modal=createWeb3Modal({
 ...
 ethersConfig:defaultConfig({
  metadata:{name:"NOX Premium",description:"Premium Analytics",url:location.origin}
 }),
 chains:[{chainId:56,name:"BSC",rpcUrl:CFG.rpc,currency:{name:"BNB",symbol:"BNB",decimals:18}}]
});
